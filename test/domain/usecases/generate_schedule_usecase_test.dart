  ...
  group('GenerateScheduleUseCase', () {
    group('call', () {
      test('should return empty list when no species selected', () {
        final result = useCase(const GenerateScheduleParams(
          speciesSelections: [],
        ));
      ...
      test('should generate schedule for single species with daily feeding', () {
      ...
      test('should generate schedule for species with three_times_daily feeding', () {
        const species = Species(
          id: 'goldfish',
          name: 'Goldfish',
    ...
    group('mergeToTimeSlots', () {
      test('should merge species with same feeding time', () {
        ...
        final schedule = useCase(const GenerateScheduleParams(
          speciesSelections: [
